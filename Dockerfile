...
# 安装 Nonebot 必要依赖
RUN pip install --no-cache-dir 'nonebot2[fastapi,httpx,websockets,aiohttp]' nonebot-adapter-onebot nonebot-plugin-resolver nonebot_plugin_emojimix nonebot-plugin-auto-sendlike -i https://pypi.tuna.tsinghua.edu.cn/simple
